...
def main():
    ...
    if dm_sim =='Bolshoi': box_size=250
    elif dm_sim == 'Chinchilla': box_size=125
    ...
    filename = 'sm_'+str(sm_lim)+'_s'+str(sm_scat)+'_sfr_c'+str(sfr_cor)+'_Halfmass_Scale_'+str(int(box_size))
    print(filename)
...
def return_mock(sm_lim=9.5, sigma=0.2, rho=-1.0, sim='Bolshoi'):
