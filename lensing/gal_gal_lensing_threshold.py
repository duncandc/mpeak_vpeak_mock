...
def main():
    ...
    if len(sys.argv)>1:
        ...
        sm_thresh = float(sys.argv[2])
    else:
        catalogue = 'sm_9.49_s0.2_sfr_c-1.0_250'
        sm_thresh=np.log10(10.0**10.2*0.7**2)
    ...
    #all galaxies
    selection = (mock['Mstar']>sm_thresh)
    ...
    #quenched galaxies
    selection_1 = (red)
    selection_2 = (mock['Mstar']>sm_thresh)
    ...
    filename_1 = catalogue+'_DeltaSigma_all_'+str(sm_thresh)+'.dat'
    ascii.write(data_1, savepath+filename_1)
    filename_2 = catalogue+'_DeltaSigma_q_'+str(sm_thresh)+'.dat'
    ascii.write(data_2, savepath+filename_2)
    filename_3 = catalogue+'_DeltaSigma_sf_'+str(sm_thresh)+'.dat'
